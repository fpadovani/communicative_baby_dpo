...
plt.figure(figsize=(8, 5))
plt.plot(df_synth["step"], df_synth["rewards/chosen"], label="Synth. - Appropriate", color="#90ee90", linewidth=line_width)
plt.plot(df_synth["step"], df_synth["rewards/rejected"], label="Synth. - Random", color="orange", linewidth=line_width)
plt.plot(df_real["step"], df_real["rewards/chosen"], label="Nat. - Appropriate", color="darkgreen", linewidth=line_width)
plt.plot(df_real["step"], df_real["rewards/rejected"], label="Nat. - Random", color="darkred", linewidth=line_width)
plt.xlabel("Step", fontsize=label_fontsize, labelpad=10)
